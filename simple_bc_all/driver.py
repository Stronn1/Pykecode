...
def bc_test_questions():
    ...
    try:
        with engine.prove_goal('rules.especie($esp)') as gen: #STUDENTS: you will need to edit this line
            for vars, plan in gen:
                print("Especie: %s" % (vars['esp'])) #STUDENTS: you will need to edit this line
